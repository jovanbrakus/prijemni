...
- **Process**: Reads the HTML solution, applies the embedded grading rubric (1.0-10.0 scale anchored to entrance exam difficulty), updates `database/problems.json`
- **Scale**: 1.0-10.0 float, anchored to entrance exam difficulty (3.0 = easiest, 9.0 = hardest)
- **Self-contained**: The skill includes the full grading rubric — agents can invoke it independently without external context
